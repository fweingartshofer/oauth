...
pub fn parse_client_registration_response_without_expiring_secret_test() {
  // Given
  let body =
    "{\"client_id\":\"client-id\",\"client_id_issued_at\":1787590528,\"client_secret\":\"asdf\",\"client_secret_expires_at\":0,\"redirect_uris\":[\"http://localhost:8080/\"],\"software_statement\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30\",\"token_endpoint_auth_method\":\"client_secret_basic\",\"grant_types\":[\"authorization_code\"],\"response_types\":[\"code\"],\"client_name\":\"gleam-client\",\"client_name#de-AT\":\"Gleam Klient\",\"client_uri\":\"http://localhost:8080/\",\"client_uri#de-AT\":\"http://localhost:8080/de-AT\",\"logo_uri\":\"http://localhost:8080/logo.svg\",\"logo_uri#de-AT\":\"http://localhost:8080/de-AT/logo.svg\",\"scope\":\"read write\",\"contacts\":[\"info@example.com\"],\"tos_uri\":\"http://localhost:8080/tos\",\"tos_uri#de-AT\":\"http://localhost:8080/de-AT/tos\",\"policy_uri\":\"http://localhost:8080/policy\",\"policy_uri#de-AT\":\"http://localhost:8080/de-AT/policy\",\"jwks_uri\":\"http://localhost:8080/uri\",\"software_id\":\"unique-id\",\"software_version\":\"v1.0.1\"}"
...
pub fn parse_client_registration_response_without_secret_test() {
  // Given
  let body =
    "{\"client_id\":\"client-id\",\"client_id_issued_at\":1787590528,\"redirect_uris\":[\"http://localhost:8080/\"],\"software_statement\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30\",\"token_endpoint_auth_method\":\"client_secret_basic\",\"grant_types\":[\"authorization_code\"],\"response_types\":[\"code\"],\"client_name\":\"gleam-client\",\"client_name#de-AT\":\"Gleam Klient\",\"client_uri\":\"http://localhost:8080/\",\"client_uri#de-AT\":\"http://localhost:8080/de-AT\",\"logo_uri\":\"http://localhost:8080/logo.svg\",\"logo_uri#de-AT\":\"http://localhost:8080/de-AT/logo.svg\",\"scope\":\"read write\",\"contacts\":[\"info@example.com\"],\"tos_uri\":\"http://localhost:8080/tos\",\"tos_uri#de-AT\":\"http://localhost:8080/de-AT/tos\",\"policy_uri\":\"http://localhost:8080/policy\",\"policy_uri#de-AT\":\"http://localhost:8080/de-AT/policy\",\"jwks_uri\":\"http://localhost:8080/uri\",\"software_id\":\"unique-id\",\"software_version\":\"v1.0.1\"}"
  let resp =
    response.Response(
      status: 201,
      headers: [#("content-type", "application/json; charset: UTF-8")],
  ...
  let resp = res |> should.be_ok()
  case resp {
    client_registration.ClientInformationResponse(client_metadata:, ..) -> {
      client_metadata
      |> client_registration.client_metadata_to_json()
      |> json.to_string()
      |> birdie.snap("Parse client registration response without secret test")
    }
    _ -> should.fail()
  }
}

pub fn parse_client_registration_response_without_jwks_test() {
  // Given
  let body =
    "{\"client_id\":\"client-id\",\"client_id_issued_at\":1787590528,\"redirect_uris\":[\"http://localhost:8080/\"],\"software_statement\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30\",\"token_endpoint_auth_method\":\"client_secret_basic\",\"grant_types\":[\"authorization_code\"],\"response_types\":[\"code\"],\"client_name\":\"gleam-client\",\"client_name#de-AT\":\"Gleam Klient\",\"client_uri\":\"http://localhost:8080/\",\"client_uri#de-AT\":\"http://localhost:8080/de-AT\",\"logo_uri\":\"http://localhost:8080/logo.svg\",\"logo_uri#de-AT\":\"http://localhost:8080/de-AT/logo.svg\",\"scope\":\"read write\",\"contacts\":[\"info@example.com\"],\"tos_uri\":\"http://localhost:8080/tos\",\"tos_uri#de-AT\":\"http://localhost:8080/de-AT/tos\",\"policy_uri\":\"http://localhost:8080/policy\",\"policy_uri#de-AT\":\"http://localhost:8080/de-AT/policy\",\"software_id\":\"unique-id\",\"software_version\":\"v1.0.1\"}"
  let resp =
    response.Response(
      status: 201,
      headers: [#("content-type", "application/json; charset: UTF-8")],
  ...
  case resp {
    client_registration.ClientInformationResponse(client_metadata:, ..) -> {
      ...
      |> client_registration.client_metadata_to_json()
      |> json.to_string()
      |> birdie.snap("Parse client registration response without jwks test")
    }
    _ -> should.fail()
  }
}

pub fn parse_client_registration_response_with_jwks_test() {
  // Given
  let body =
    "{\"client_id\":\"client-id\",\"client_id_issued_at\":1787590528,\"redirect_uris\":[\"http://localhost:8080/\"],\"software_statement\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30\",\"token_endpoint_auth_method\":\"client_secret_basic\",\"grant_types\":[\"authorization_code\"],\"response_types\":[\"code\"],\"client_name\":\"gleam-client\",\"client_name#de-AT\":\"Gleam Klient\",\"client_uri\":\"http://localhost:8080/\",\"client_uri#de-AT\":\"http://localhost:8080/de-AT\",\"logo_uri\":\"http://localhost:8080/logo.svg\",\"logo_uri#de-AT\":\"http://localhost:8080/de-AT/logo.svg\",\"scope\":\"read write\",\"contacts\":[\"info@example.com\"],\"tos_uri\":\"http://localhost:8080/tos\",\"tos_uri#de-AT\":\"http://localhost:8080/de-AT/tos\",\"policy_uri\":\"http://localhost:8080/policy\",\"policy_uri#de-AT\":\"http://localhost:8080/de-AT/policy\",\"software_id\":\"unique-id\",\"software_version\":\"v1.0.1\",\"jwks\":{\"keys\":[]}}"
  let resp =
    response.Response(
      status: 201,
      headers: [#("content-type", "application/json; charset: UTF-8")],
  ...
  case resp {
    client_registration.ClientInformationResponse(client_metadata:, ..) -> {
      ...
      |> client_registration.client_metadata_to_json()
      |> json.to_string()
      |> birdie.snap("Parse client registration response with jwks test")
    }
    _ -> should.fail()
  }
}

pub fn parse_client_registration_response_with_jwks_and_jwks_uri_fails_test() {
  // Given
  let body =
    "{\"client_id\":\"client-id\",\"client_id_issued_at\":1787590528,\"redirect_uris\":[\"http://localhost:8080/\"],\"software_statement\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30\",\"token_endpoint_auth_method\":\"client_secret_basic\",\"grant_types\":[\"authorization_code\"],\"response_types\":[\"code\"],\"client_name\":\"gleam-client\",\"client_name#de-AT\":\"Gleam Klient\",\"client_uri\":\"http://localhost:8080/\",\"client_uri#de-AT\":\"http://localhost:8080/de-AT\",\"logo_uri\":\"http://localhost:8080/logo.svg\",\"logo_uri#de-AT\":\"http://localhost:8080/de-AT/logo.svg\",\"scope\":\"read write\",\"contacts\":[\"info@example.com\"],\"tos_uri\":\"http://localhost:8080/tos\",\"tos_uri#de-AT\":\"http://localhost:8080/de-AT/tos\",\"policy_uri\":\"http://localhost:8080/policy\",\"policy_uri#de-AT\":\"http://localhost:8080/de-AT/policy\",\"software_id\":\"unique-id\",\"software_version\":\"v1.0.1\",\"jwks\":{\"keys\":[]},\"jwks_uri\":\"https://example.com\"}"
  let resp =
    response.Response(
      status: 201,
      headers: [#("content-type", "application/json; charset: UTF-8")],
...
pub fn parse_client_registration_response_without_secret_expires_at_fails_test() {
  // Given
  let body =
  ...
  |> should.be_error()
  |> should.equal(
    client_registration.MalformedMessageBody(
      json.UnableToDecode([
        decode.DecodeError("Field", "Nothing", ["client_secret_expires_at"]),
      ]),
    ),
  )
}

pub fn parse_client_registration_response_with_invalid_content_type_test() {
  // Given
  let body = "Plain Text"
  let resp =
    response.Response(
  ...
  res
  |> should.be_error()
  |> should.equal(client_registration.UnsupportedContent("text/plain"))
}

pub fn parse_client_registration_response_with_error_response_test() {
  // Given
  let body =
    "{\"error\":\"invalid_client_metadata\",\"error_description\":\"Unknown language\"}"
  let resp =
    response.Response(
      status: 400,
  ...
  res
  |> should.be_error()
  |> should.equal(client_registration.ErrorResponse(
    400,
    "invalid_client_metadata",
    "Unknown language" |> option.Some,
  ))
}
